...
Save the code as logger.cpp.
Compile using your preferred C++ compiler:
bash
g++ -std=c++17 logger.cpp -o command_logger
...
Configuration
To change the listening port, modify the PORT variable in the main() function:
cpp
int PORT = 9000; // Example: Switch to port 9000
Use code with caution.
